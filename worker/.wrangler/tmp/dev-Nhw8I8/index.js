...
async function get6(request, env) {
  return new Response(JSON.stringify({ error: "Chaos test failure" }), { status: 500, headers: { "Content-Type": "application/json" } });
}
__name(get6, "get");
...
// .wrangler/tmp/bundle-pANq3m/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pANq3m/middleware-loader.entry.ts
