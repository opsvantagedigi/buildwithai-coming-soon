...
// src/routes/domain-check.js
var domain_check_default = {
...
// src/routes/domain-pricing.js
var domain_pricing_default = {
  async fetch(request, env, ctx) {
...
// src/routes/domain-register.js
var domain_register_default = {
  async fetch(request, env, ctx) {
    if (request.method !== "POST") {
      return new Response("Method Not Allowed", { status: 405 });
    }
...
// src/routes/domain-whois.js
var domain_whois_default = {
  async fetch(request, env, ctx) {
    if (request.method !== "POST") {
      return new Response("Method Not Allowed", { status: 405 });
    }
...
var src_default = {
  async fetch(request, env, ctx) {
    ...
    if (path === "/domain/check") {
      ...
      return domain_check_default.fetch(request, env, ctx);
    }
    if (path === "/domain/pricing") {
      if (request.method !== "GET") {
        return new Response("Method Not Allowed", { status: 405 });
      }
      return domain_pricing_default.fetch(request, env, ctx);
    }
    if (path === "/domain/register") {
      if (request.method !== "POST") {
        return new Response("Method Not Allowed", { status: 405 });
      }
      return domain_register_default.fetch(request, env, ctx);
    }
    if (path === "/domain/whois") {
      if (request.method !== "POST") {
        return new Response("Method Not Allowed", { status: 405 });
      }
      return domain_whois_default.fetch(request, env, ctx);
    }
...
// .wrangler/tmp/bundle-Br00e2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Br00e2/middleware-loader.entry.ts
